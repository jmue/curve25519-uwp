...
copy deploy\nuget\curve25519.targets %StagingPath%\build\native
...
REM stage x86
copy curve25519\Release\curve25519\curve25519.dll %StagingPath%\lib\uap10.0
copy curve25519\Release\curve25519\curve25519.winmd %StagingPath%\lib\uap10.0
copy curve25519\Release\curve25519\curve25519.pri %StagingPath%\lib\uap10.0
...
REM (Note: Expect 3 Assembly outside lib folder warnings, due to WinRT custom packaging technique)
